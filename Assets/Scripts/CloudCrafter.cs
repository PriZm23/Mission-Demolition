...
public class CloudCrafter : MonoBehaviour
{
    ...
    public float cloudScaleMin = 1; // Мин. массштаб каждого облака
    public float cloudScaleMax = 3; // Макс. массштаб каждого облака
    ...
    private void Awake()
    {
        ...
        for(int i = 0; i < numClouds; i++)
        {
            ...
            // Массштабировать облако
            float scaleU = Random.value;
            float scaleVal = Mathf.Lerp(cloudScaleMin, cloudScaleMax, scaleU);

            // Меньшие облака (с меньшим значением scaleU) должны быть 
            // ближе к земле
            ...
            // Применить полученные значения координат и массштаба к облаку
    ...
    private void Update()
    {
        ...
        {
            // Получить массштаб и координаты облака
